const detailContent = {
  ...
  "concept-task-separation": {
    ...
    title: "課題分離：先釐清責任歸屬",
    body: [
      block("核心定義", ["課題分離不是把孩子推開，而是先判斷這件事是孩子的問題，還是孩子與大人的共同問題。", "只有先釐清問題歸屬，後續才知道要讓孩子承擔自然後果，或由親子一起協商並設計邏輯後果。"]),
      block("兩種問題歸屬", ["孩子的問題：孩子能在安全與能力範圍內承擔結果，大人以陪伴、提醒與事後回顧支持學習。", "孩子與大人的共同問題：孩子的選擇會影響家庭秩序、他人權益、安全或共同資源，需要大人提供必要保護、一起訂規範，並讓孩子參與修復與練習。"]),
      block("判斷問題", ["這是孩子的問題，還是孩子與大人的共同問題？", "孩子是否有能力在安全範圍內承擔？", "結果會影響家庭秩序、他人權益或共同資源嗎？", "是否涉及安全、健康、生命或重大風險？", "大人需要提供哪些界線、資源或協助？"]),
      script("平台判斷句", "先確認這是孩子的問題，還是孩子與大人的共同問題；孩子能安全承擔且不影響他人，就讓自然後果發生；若需要共同處理，就由大人設下相關、尊重、合理且事前告知的邏輯後果，並讓孩子參與修復。"),
      block("延伸閱讀", ['<a class="inline-link" href="consequences.html">開啟整合頁：問題歸屬與後果選擇</a>'])
    ]
  },
...
const sectionSearchRecords = [
  ...
  },
  {
    ...
    key: "consequences",
    label: "整合教學頁",
    title: "孩子的問題，或孩子與大人的共同問題",
    summary: "先判斷問題是孩子的，還是孩子與大人的共同課題，再比較自然後果與邏輯後果，最後用 4R 檢查是否尊重且合理。",
