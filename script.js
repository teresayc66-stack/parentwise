...
const libraryEntries = [
  {
    key: "kb-encouragement",
    category: "adler",
    label: "阿德勒核心",
    title: "鼓勵：讓孩子長出勇氣",
    summary: "從資料中的鼓勵講義與句型練習整理，區分鼓勵、稱讚與獎賞。",
    content: {
      source: "鼓勵講義、鼓勵句型練習、青少年溝通筆記",
      concept: ["鼓勵的核心不是評價孩子很棒，而是讓孩子看見自己的能力、努力、進步與貢獻。", "孩子的不適當行為常與挫折、缺乏勇氣或缺乏歸屬感有關。"],
      useWhen: ["孩子失敗、受挫或不願再嘗試。", "家長想培養責任感、合作能力與自我價值。", "孩子只在被稱讚或被獎賞時才願意行動。"],
      steps: ["描述具體行為。", "指出孩子展現的能力、努力、進步或貢獻。", "避免加上比較、控制或交換條件。", "讓孩子知道他可以再嘗試一次。"],
      mistakes: ["把鼓勵說成空泛稱讚。", "鼓勵後又算舊帳。", "只在孩子成功時鼓勵，失敗時只責備。"],
      tools: ["鼓勵句型練習單", "努力與進步觀察表", "親子正向回饋紀錄"]
    }
  },
  {
    key: "kb-encouragement-formulas",
    category: "tools",
    label: "工具與練習",
    title: "鼓勵的 10 個公式",
    summary: "整理自鼓勵的十種方法與鼓勵句型摘要，讓家長能把鼓勵從觀念轉成可說出口的句子。",
    content: {
      source: "鼓勵的十種方法、鼓勵句型 1-10 摘要",
      concept: ["鼓勵公式不是背台詞，而是訓練家長看見孩子的接納、能力、努力、進步、貢獻與修復可能。", "每一句鼓勵都要盡量具體，避免變成空泛稱讚、比較或交換條件。"],
      useWhen: ["孩子受挫、退縮、不願再試。", "孩子已經做出一點點合適行為，需要被看見。", "家長想把責備改成有方向的回饋。", "孩子犯錯後，需要學會補救而不是只感到羞愧。"],
      steps: [
        "1. 無條件接納：描述孩子的行為、情緒或想法，讓孩子知道他被看見。",
        "2. 感謝貢獻：描述孩子做了什麼，再說明你對這個行為後果的感謝或欣賞。",
        "3. 看見長處：用具體行為加上一個特質詞，幫孩子辨認自己的優勢。",
        "4. 看見努力與進步：指出事情經過、練習、用心，或比較這次與上次的進展。",
        "5. 關心興趣：先知道孩子有興趣的事，再用詢問或陪伴表達關心。",
        "6. 肯定正向方法：指出孩子擅長或曾有經驗的地方，並向孩子請教。",
        "7. 表達信心：從孩子已經做到的基礎出發，說出你相信他可以再往前一步。",
        "8. 從錯誤學習：描述不適當的事，再引導孩子想可以怎麼補救或下次怎麼做。",
        "9. 示範不完美的勇氣：大人承認自己做錯的具體事情，示範可以修正。",
        "10. 忽略不適當、鼓勵適當：在孩子已經做的事情中，先鼓勵合適的部分，減少放大未達標的部分。"
      ],
      mistakes: ["把公式用成操控孩子的話術。", "只在孩子成功時使用，失敗時又回到責罵。", "句子太抽象，例如只說你好棒、你好乖。", "鼓勵之後補一句但是，讓前面的鼓勵失效。"],
      tools: ["鼓勵 10 公式練習單", "每日一句具體鼓勵紀錄", "錯誤後補救對話腳本"]
    }
  },
  {
    key: "kb-task-separation",
    category: "adler",
    label: "阿德勒核心",
    title: "課題分離與問題歸屬",
    summary: "整理自課題分離參考文與我的訊息練習：先判斷是孩子、家長或共同課題。",
    content: {
      source: "課題分離參考文、我的訊息練習、問題是誰的筆記",
      concept: ["課題分離是先釐清責任歸屬，不是冷漠放手。", "孩子能負擔、後果有限且無安全健康疑慮時，偏向孩子課題。涉及生命、健康、安全、家庭支出或他人權益時，家長必須介入。"],
      useWhen: ["家長不確定要不要管。", "孩子的行為可能造成家長額外成本。", "需要決定自然後果或邏輯後果。"],
      steps: ["問：後果由誰承擔？", "問：孩子能否承擔？", "檢查金額、安全、健康、生命與他人權益。", "孩子可承擔則自然後果；超出範圍則邏輯後果。"],
      mistakes: ["把課題分離理解為什麼都不管。", "孩子無法承擔後果時仍放手。", "家長自己的焦慮被誤認為孩子的問題。"],
      tools: ["課題分離判斷表", "自然後果檢核表", "邏輯後果設計單"]
    }
  },
  {
    key: "kb-natural-logical",
    category: "adler",
    label: "阿德勒核心",
    title: "自然後果與邏輯後果",
    summary: "整理自邏輯後果講義與合作班資料，聚焦用後果培養責任，而非懲罰。",
    content: {
      source: "邏輯後果講義、合作與負責任課程、我的訊息練習",
      concept: ["自然後果是讓孩子經驗自己的選擇所帶來的自然結果。", "邏輯後果是當事情涉及安全、秩序、費用或他人權益時，家長用尊重、相關、合理的方式設規範。"],
      useWhen: ["孩子可承擔小範圍後果。", "孩子行為影響家庭規範或他人權益。", "家長想取代獎賞與懲罰。"],
      steps: ["先做課題分離。", "確認是否有安全健康風險。", "自然後果：不急著補救。", "邏輯後果：事先說明選擇與後果。", "事後鼓勵孩子從經驗中學習。"],
      mistakes: ["用邏輯後果包裝懲罰。", "後果和行為沒有關聯。", "在情緒高張時臨時加重後果。"],
      tools: ["後果三原則檢核表", "家庭規範設計表", "一週後果追蹤表"]
    }
  },
  {
    key: "kb-i-message",
    ...
    label: "溝通與情緒",
    title: "我的訊息：溫柔而清楚地表達",
    summary: "整理自我的訊息講義與大量情境練習，將責備改成清楚表達需求。",
    content: {
      source: "我的訊息講義、練習題、電話情境與生活情境作業",
      concept: ["我的訊息是用事實、感受／擔心、影響與期待來表達，而不是用責備攻擊對方。", "它適合用在家長的情境需求被影響，或共同生活規範需要被尊重時。"],
      useWhen: ["孩子行為干擾家長或他人。", "家長想設界線但不想責罵。", "需要接到邏輯後果。"],
      steps: ["先描述客觀事實。", "說出自己的擔心或感受。", "說明影響。", "提出可選擇的行動。", "孩子合作後給具體鼓勵。"],
      mistakes: ["用『我覺得你很不乖』包裝指責。", "只說情緒，沒有提出具體需求。", "說完我的訊息後又開始說教。"],
      tools: ["我的訊息改寫單", "情境需求判斷表", "對話腳本卡"]
    }
  },
  {
    key: "kb-empathy-listening",
    category: "communication",
    label: "溝通與情緒",
    title: "同理心與傾聽",
    summary: "整理自同理心筆記與青少年溝通資料，重點是先打開心門，再解決問題。",
    content: {
      source: "同理心課程筆記、青少年班筆記、溝通參考文",
      concept: ["同理不是同意所有行為，而是先理解孩子的經驗、情緒與目的。", "傾聽的價值在於讓孩子感覺被理解，並逐漸能整理自己的想法。"],
      useWhen: ["孩子情緒強烈。", "孩子關門、不說話或防衛。", "家長想影響青少年而非控制。"],
      steps: ["放下手邊事情。", "先反映孩子可能的感受。", "不要急著糾正或講道理。", "等情緒降下來，再邀請孩子想方法。"],
      mistakes: ["同理後立刻接『但是』。", "把同理當技巧話術。", "聽的時候其實在準備說教。"],
      tools: ["情緒詞彙表", "同理句型練習", "親子談話紀錄"]
    }
  },
  {
    key: "kb-mistaken-goals",
    category: "adler",
    label: "阿德勒核心",
    title: "錯誤行為目標",
    summary: "整理自錯誤行為目標講義與青少年回應資料，理解行為背後的目的。",
    content: {
      source: "孩子錯誤目標講義、青少年錯誤行為回應、個案談話資料",
      concept: ["孩子的不當行為常是在追求歸屬感，只是用了錯誤方式。", "常見方向包含引起注意、爭取權力、報復、自暴自棄。"],
      useWhen: ["孩子反覆出現同類行為。", "家長越管越沒效。", "親子互動陷入固定循環。"],
      steps: ["觀察家長自己的感受：煩、怒、受傷或無力。", "推測孩子可能的行為目的。", "改變家長反應。", "提供孩子正向取得歸屬感的方法。"],
      mistakes: ["把行為目標當標籤貼在孩子身上。", "只分析孩子，不改變家長回應。", "忽略孩子能力不足的可能。"],
      tools: ["錯誤行為目標判讀表", "家長反應紀錄", "替代行為設計單"]
    }
  },
  {
    key: "kb-respect-communication",
    category: "communication",
    label: "溝通與情緒",
    title: "尊重與主動有效溝通",
    summary: "整理自主動有效溝通、青少年合作與尊重講義。",
    content: {
      source: "主動有效溝通講義、青少年班筆記、合作班資料",
      concept: ["尊重不是放任，也不是權威壓制，而是同時看見家長與孩子的需要。", "有效溝通要先確認目的：分享、邀請、說服、協商或設界線。"],
      useWhen: ["青少年不願合作。", "家長想談重要議題。", "家庭需要建立共同規範。"],
      steps: ["先建立關係。", "談孩子有興趣或在意的事。", "用具體事實而非評價開場。", "以問句邀請思考。", "保留孩子選擇與承擔後果的空間。"],
      mistakes: ["把溝通變成審問。", "一開口就否定孩子。", "想說服孩子，卻沒有先理解孩子的需求。"],
      tools: ["溝通目的檢核表", "青少年對話腳本", "家庭協議表"]
    }
  },
  {
    key: "kb-cooperation-family-meeting",
    category: "family",
    label: "家庭系統",
    title: "合作與家庭會議",
    summary: "整理自家庭會議章節與合作班資料，將親子衝突轉成共同解決問題。",
    content: {
      source: "家庭會議講義、合作班資料、青少年合作筆記",
      concept: ["家庭會議是一種定期、平等、聚焦解決問題的家庭練習。", "重點問題是：對於這件事，我們能做什麼？"],
      useWhen: ["家庭規範反覆失效。", "手足或親子問題需要共同討論。", "家長想訓練孩子參與決策與承擔。"],
      steps: ["固定時間。", "先肯定與感謝。", "一次只討論少數議題。", "讓每個人提出方法。", "選一個可執行方案並追蹤。"],
      mistakes: ["把家庭會議變成訓話。", "一次處理太多問題。", "只讓大人決定，小孩只是被通知。"],
      tools: ["家庭會議議程表", "共同解決問題單", "家庭規範追蹤表"]
    }
  },
  {
    key: "kb-birth-order",
    ...
    label: "家庭系統",
    title: "出生序與家庭星座",
    summary: "整理自出生序、家庭星座與手足資料，用來理解孩子在家庭中的心理位置。",
    content: {
      source: "出生序講義、家庭星座問卷、手足關係資料",
      concept: ["出生序不是命定性格，而是理解孩子如何在家庭中尋找位置的線索。", "同一排行也會因性別、年齡差、父母期待、家庭事件而呈現不同樣貌。"],
      useWhen: ["手足競爭明顯。", "孩子常覺得不公平。", "家長想理解孩子在家中的角色與位置。"],
      steps: ["整理家庭成員與年齡差。", "觀察孩子最常爭取的是注意、權力、照顧或自由。", "避免固定把某個孩子放進角色。", "創造每個孩子可貢獻的位置。"],
      mistakes: ["把出生序當算命。", "用排行替孩子貼標籤。", "忽略家庭氣氛與父母互動的影響。"],
      tools: ["家庭星座圖", "手足位置觀察表", "每個孩子貢獻任務表"]
    }
  },
  {
    key: "kb-early-recollection",
    category: "family",
    label: "家庭系統",
    title: "童年回憶與生命風格",
    summary: "整理自早期回憶、生命風格與生活模式資料，用來理解一個人的看世界方式。",
    content: {
      source: "早期回憶講義、生命風格筆記、童年回憶練習",
      concept: ["童年回憶不是為了判定真相，而是觀察個人如何解釋世界、自己與他人的關係。", "阿德勒觀點重視行為目的與主觀解釋。"],
      useWhen: ["想理解家長自己的教養慣性。", "孩子或家長反覆用同一模式處理壓力。", "進階學習生命風格分析。"],
      steps: ["記錄一個具體、單一的早期畫面。", "寫下當時情緒、互動對象、最鮮明的細節。", "觀察其中的信念與行動方向。", "回到現在：下一次可以怎麼微調。"],
      mistakes: ["把回憶當客觀歷史。", "急著分析別人。", "把生命風格當不可改變的命運。"],
      tools: ["早期回憶紀錄單", "生命風格線索表", "自我覺察反思單"]
    }
  },
  {
    key: "kb-teen-parenting",
    category: "teen",
    label: "青少年",
    title: "青少年教養：影響而非控制",
    summary: "整理自青少年班、合作班與主動溝通資料。",
    content: {
      source: "青少年班筆記、合作班講義、主動有效溝通資料",
      concept: ["青少年需要更多自主與尊重，家長若只靠控制，容易引發權力衝突。", "家長仍然要設安全與價值界線，但方式要從命令轉向影響、協商與陪伴。"],
      useWhen: ["孩子疏離、不說話。", "手機、交友、學業或外出議題引發衝突。", "家長擔心風險但不想失去關係。"],
      steps: ["先維持連結。", "釐清哪些是安全底線。", "把價值觀變成討論題，不是訓話。", "讓孩子參與規則與後果設計。"],
      mistakes: ["用小孩時期的方法管青少年。", "只談成績，不談生活與感受。", "把關心變成監控。"],
      tools: ["青少年對話腳本", "手機使用協議", "風險情境討論單"]
    }
  },
  {
    key: "kb-emotion-education",
    category: "communication",
    label: "溝通與情緒",
    title: "情緒教育與問題解決",
    summary: "整理自情緒用語、問題解決與孩子吵架處理資料。",
    content: {
      source: "情緒詞彙資料、問題解決講義、孩子衝突處理參考文",
      concept: ["情緒是訊號，不是麻煩。孩子需要先被協助命名與安頓，才有能力進入問題解決。", "問題解決能力需要練習，不是孩子自然就會。"],
      useWhen: ["孩子哭鬧、生氣、焦慮或挫折。", "手足或同儕衝突。", "孩子只會用情緒表達需求。"],
      steps: ["先安頓安全與情緒。", "命名情緒。", "描述問題。", "想三個可能方法。", "選一個先試，事後回顧。"],
      mistakes: ["急著講道理。", "否定孩子情緒。", "大人直接給答案，孩子沒有練習。"],
      tools: ["情緒觀察表", "問題解決五步驟卡", "情緒詞彙表"]
    }
  },
  {
    key: "kb-love-languages",
    category: "communication",
    label: "溝通與情緒",
    title: "愛的言語與親子連結",
    summary: "整理自兒童愛之語與愛的言語練習表。",
    content: {
      source: "兒童愛之語講義、愛的言語練習表、鼓勵練習",
      concept: ["孩子感受到被愛的方式可能不同，家長不能只用自己習慣的方式表達愛。", "連結足夠時，管教與訓練較容易被孩子接收。"],
      useWhen: ["家長覺得自己很愛孩子，但孩子感受不到。", "親子關係疏離。", "孩子需要更多情感連結後再談規範。"],
      steps: ["觀察孩子最常要求什麼：陪伴、肯定、禮物、服務或身體接觸。", "每週安排具體連結行動。", "搭配鼓勵，而非交換條件。"],
      mistakes: ["用愛的言語控制孩子。", "把禮物當補償。", "忽略孩子實際需要的連結方式。"],
      tools: ["愛的言語觀察表", "精心時刻計畫表", "親子連結紀錄"]
    }
  },
  {
    key: "kb-responsibility-training",
    category: "teen",
    label: "青少年",
    title: "責任感與自我管理",
    summary: "整理自負責任與訓練、合作班與學習自我管理資料。",
    content: {
      source: "負責任與訓練講義、合作班資料、自我管理筆記",
      concept: ["責任感不是靠罵出來，而是在可承擔的範圍內練習義務、選擇與後果。", "孩子需要從被提醒，逐步走向自己規劃與自我評估。"],
      useWhen: ["功課拖延、家事逃避、生活常規混亂。", "孩子依賴大人提醒。", "青少年需要更多自主但能力尚未成熟。"],
      steps: ["把任務具體化。", "讓孩子參與規劃。", "設定可追蹤標準。", "用自然或邏輯後果回饋。", "鼓勵努力與進步。"],
      mistakes: ["父母全部代勞。", "只要求結果，不訓練方法。", "孩子一失敗就收回所有自主。"],
      tools: ["任務拆解表", "責任追蹤表", "自我管理週計畫"]
    }
  },
  {
    key: "kb-sibling-conflict",
    category: "family",
    label: "家庭系統",
    title: "手足衝突與合作",
    summary: "整理自手足、出生序、兄弟合作與家庭關係資料。",
    content: {
      source: "手足問卷、出生序資料、兄弟合作案例、青少年筆記",
      concept: ["手足衝突常不只是玩具或事件本身，而是孩子在爭位置、注意、公平與重要感。", "父母固定偏向某一方，容易強化衝突角色。"],
      useWhen: ["孩子常爭寵、告狀、比較。", "大的被要求一直讓小的。", "手足衝突影響家庭氣氛。"],
      steps: ["先停止傷害與升高衝突。", "描述事實，不急著判決。", "讓每個孩子說需求。", "共同想替代方案。", "鼓勵合作與修復行動。"],
      mistakes: ["永遠要求大的讓。", "誰哭就站誰那邊。", "用比較激勵孩子。"],
      tools: ["手足衝突紀錄表", "輪流與協商規則卡", "修復對話腳本"]
    }
  },
  {
    key: "kb-risk-safety",
    ...
    label: "青少年",
    title: "風險、安全與界線議題",
    summary: "整理自青少年交友、霸凌、暴力衝突、性與藥物等議題筆記。",
    content: {
      source: "青少年議題筆記、霸凌與暴力處理資料、交友與安全討論資料",
      concept: ["涉及生命、健康、安全、法律或重大風險時，不能只做自然後果，家長必須介入設界線。", "高風險議題要事前討論替代方案，而不是事後只責備。"],
      useWhen: ["霸凌、暴力、性、藥物、夜歸、網路風險。", "孩子的選擇可能造成不可逆後果。", "家長需要在尊重與保護之間拿捏。"],
      steps: ["先判斷安全等級。", "需要時立即停止風險行為。", "事後用同理與事實討論。", "建立明確界線與求助管道。", "必要時轉介專業。"],
      mistakes: ["把高風險議題當普通自由選擇。", "只恐嚇，不教替代方案。", "家長怕破壞關係而不設界線。"],
      tools: ["風險分級表", "安全界線協議", "求助資源清單"]
    }
  }
];

libraryEntries.forEach((entry) => {
  detailContent[entry.key] = kbDetail(entry);
});
...
const sectionSearchRecords = [
  ...
  },
  {
    ...
    label: "頁面區塊",
    title: "知識庫",
    summary: "從筆記整理出的阿德勒、溝通、情緒、青少年、工具與案例知識卡。",
    keywords: "鼓勵 課題分離 自然後果 邏輯後果 我的訊息"
  },
  {
    type: "section",
    key: "content",
...
function kbDetail(entry) {
  return {
    kicker: `知識庫 · ${entry.label}`,
    title: entry.title,
    body: [
      block("內容來源群組", [entry.content.source]),
      block("核心觀念", entry.content.concept),
      block("適用情境", entry.content.useWhen),
      block("操作流程", entry.content.steps),
      block("常見誤用", entry.content.mistakes),
      block("可搭配工具", entry.content.tools)
    ]
  };
}
...
const renderLibrary = (filter = "all") => {
  ...
  const entries = filter === "all" ? libraryEntries : libraryEntries.filter((entry) => entry.category === filter);
  grid.innerHTML = entries
    .map(
      (entry) => `
        <article class="library-card" data-detail="${entry.key}">
          <span>${entry.label}</span>
          <h3>${entry.title}</h3>
          <p>${entry.summary}</p>
          <button type="button" class="detail-button" data-detail="${entry.key}">查看內容</button>
        </article>
      `
    )
    .join("");
